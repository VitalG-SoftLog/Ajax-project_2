...
namespace ReportBuilderAjax.Web.HttpHandlers
{
         ...
         where T : IUniversalDuplexContract, new()
    {
        ...
        public override ServiceHostBase CreateServiceHost(string constructorString, Uri[] baseAddresses)
        {
            ...
            polling.InactivityTimeout = TimeSpan.FromHours(2);*/
            ...
            if (!service.Description.Behaviors.Contains(typeof(ServiceMetadataBehavior)))
            {
    ...
    {    
        ...
        public void OnPushMessageComplete(IAsyncResult iar)
        {
            if (iar.CompletedSynchronously)
            {
                return;
        ...
        {
            System.Diagnostics.Debug.WriteLine("Channel_Closing (server): " + DateTime.Now.TimeOfDay.ToString());
        ...
        {
            System.Diagnostics.Debug.WriteLine("Channel_Faulted (server): " + DateTime.Now.TimeOfDay.ToString());
    ...
    [KnownType(typeof(GenerateReportRequest))]
    [KnownType(typeof(GenerateUserReportRequest))]
    [KnownType(typeof(GenerateStandardReportRequest))]
    [KnownType(typeof(GenerateCustomReportRequest))]
    [KnownType(typeof(GenerateReportResponse))]
    [KnownType(typeof(CancelReportRequest))]    
